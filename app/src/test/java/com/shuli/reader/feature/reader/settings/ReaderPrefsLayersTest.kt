...
class ReaderPrefsLayersTest {
    ...
    fun layoutPrefs_containsGeometryFields() {
        ...
        assertEquals(prefs.bodyBox.left, layout.marginHorizontal, 0.001f)
        assertEquals(prefs.bodyBox.top, layout.marginVertical, 0.001f)
        assertEquals(prefs.bodyBox.top, layout.marginTop)
        assertEquals(prefs.bodyBox.bottom, layout.marginBottom)
        assertEquals(prefs.bodyBox.left, layout.marginLeft)
        assertEquals(prefs.bodyBox.right, layout.marginRight)
