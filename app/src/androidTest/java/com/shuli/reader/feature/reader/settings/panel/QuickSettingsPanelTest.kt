...
import com.shuli.reader.feature.reader.settings.panel.ReaderSettingsPanel
...
class QuickSettingsPanelTest {
    ...
    fun peekState_showsPeekContent() {
        setContent()
        compose.onNodeWithTag("ReaderSettingsPanel_PeekContent").assertIsDisplayed()
    }
    ...
    fun peekState_tabRowNotVisible() {
        ...
        compose.onNodeWithTag("ReaderSettingsPanel").assertIsDisplayed()
    }
    ...
    fun expandedContent_exists() {
        setContent()
        compose.waitForIdle()
        compose.onNodeWithTag("ReaderSettingsPanel_ExpandedContent").assertIsDisplayed()
    }
    ...
    fun tabRow_exists() {
        setContent()
        compose.waitForIdle()
        compose.onNodeWithTag("ReaderSettingsPanel_TabRow").assertIsDisplayed()
    }
}
