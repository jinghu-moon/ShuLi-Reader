...
enum class UiGroup {
    ...
    THEME, PAGE_CHROME, PAGE_CONTENT, DISPLAY_MODE, VISUAL_AIDS,
...
object ReaderSettingRegistry {
    ...
    val all: List<SettingDefinition<*>> = buildList {
        ...
        add(SettingDefinition(key = "header_box", defaultValue = BoxInsetsDp(16f, 0f, 24f, 24f), storageTier = StorageTier.BOTH, scope = InvalidationScope.REFLOW, recompositionTier = 3, uiGroup = UiGroup.TEXT_LAYOUT, includeInPreset = true, previewStrategy = PreviewStrategy.LIVE))
        add(SettingDefinition(key = "footer_box", defaultValue = BoxInsetsDp(0f, 16f, 24f, 24f), storageTier = StorageTier.BOTH, scope = InvalidationScope.REFLOW, recompositionTier = 3, uiGroup = UiGroup.TEXT_LAYOUT, includeInPreset = true, previewStrategy = PreviewStrategy.LIVE))
        add(SettingDefinition(key = "title_box", defaultValue = BoxInsetsDp(9f, 10f, 24f, 24f), storageTier = StorageTier.BOTH, scope = InvalidationScope.REFLOW, recompositionTier = 3, uiGroup = UiGroup.TEXT_LAYOUT, includeInPreset = true, previewStrategy = PreviewStrategy.LIVE))
        add(SettingDefinition(
        ...
        add(SettingDefinition(key = "title_font_size", defaultValue = 22f, storageTier = StorageTier.BOTH, scope = InvalidationScope.REFLOW, recompositionTier = 3, uiGroup = UiGroup.TEXT_LAYOUT, includeInPreset = true, previewStrategy = PreviewStrategy.LIVE))
        add(SettingDefinition(
            key = "title_font",
            defaultValue = "",
            storageTier = StorageTier.BOTH,
