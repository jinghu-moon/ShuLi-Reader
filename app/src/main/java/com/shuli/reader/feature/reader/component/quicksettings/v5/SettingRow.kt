...
import com.shuli.reader.feature.reader.component.quicksettings.v5.controls.InkSelect
...
fun SwitchRow(
    ...
    SettingRow(
        ...
        Row(
            ...
            InkToggle(checked = checked, onCheckedChange = onCheckedChange)
        }
    }
}
...
fun DividerSwitchRow(
    ...
    val lineAlpha by androidx.compose.animation.core.animateFloatAsState(
        targetValue = if (checked) 0.55f else 0f,
