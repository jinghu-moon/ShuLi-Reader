...
fun ReaderUiState.toRenderInput(
    ...
    val layoutInput = ReaderLayoutInput(
        ...
        marginTopDp = prefs.bodyBox.top,
        marginBottomDp = prefs.bodyBox.bottom,
        marginLeftDp = prefs.bodyBox.left,
        marginRightDp = prefs.bodyBox.right,
        indent = prefs.indent,
        ...
        headerMarginTopDp = prefs.headerBox.top,
        footerMarginBottomDp = prefs.footerBox.bottom,
